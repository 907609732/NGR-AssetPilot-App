...
const els = {
  ...
  apiSettingsAiSlot: document.querySelector("#apiSettingsAiSlot"),
  apiSettingsTranslationSlot: document.querySelector("#apiSettingsTranslationSlot"),
  ...
  clearAiCredential: document.querySelector("#clearAiCredential"),
  ...
  clearTranslatorCredential: document.querySelector("#clearTranslatorCredential"),
